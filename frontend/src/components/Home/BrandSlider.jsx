// BrandSlider.jsx – Manual carousel with arrow buttons
...
function BrandSlider({ brands = [] }) {
  ...
  if (!brands.length) {
    return (
      <section
        className="py-12 bg-transparent w-full text-right border-y border-gray-100/60"
        dir="rtl"
      >
  ...
  return (
    <section
      className="py-12 bg-transparent w-full overflow-hidden text-right border-y border-gray-100/60"
      dir="rtl"
    >
